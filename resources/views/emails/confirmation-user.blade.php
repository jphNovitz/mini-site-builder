<div style="font-family: Arial, Helvetica, sans-serif; color: #1e293b; line-height: 1.6;">
    <h1 style="font-size: 20px; margin: 0 0 12px;">Votre carte de visite a bien été créée</h1>
    <p style="margin: 0 0 16px;">Dès validation, elle sera en ligne. Vous recevrez une seconde notification.</p>
